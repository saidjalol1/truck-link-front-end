    ...
    <div class="menu shadow p-3">
        ...
        <div class="menus mt-6 flex flex-col">
            <div class="item px-2 py-2 rounded-lg flex flex-col items-center cursor-pointer hover:text-blue-600"
                ...
                <div class="text text-xs mt-1 hover:text-blue-400">Jo'natma</div>
            </div>
            <div class="item px-2 py-2  rounded-lg flex flex-col items-center cursor-pointer hover:text-blue-600"
            ...
            <div class="item px-2 py-2  rounded-lg flex flex-col items-center cursor-pointer hover:text-blue-600"
                ...
                <div class="text text-xs mt-1 hover:text-blue-400">Xarita</div>
            </div>
            <div class="item px-2 py-2 rounded-lg flex flex-col items-center cursor-pointer hover:text-blue-600"
                ...
                <div class="text text-xs mt-1 hover:text-blue-400">Sozlamalar</div>
            </div>
        </div>
    </div>
</template>
