...
<template>
        <div class="menu flex flex gap-6 px-4">
            <div class="item flex flex-col items-center cursor-pointer hover:text-blue-600">
                ...
                <div class="text text-xs mt-1 hover:text-blue-400">Jo'natmalar</div>
            </div>
            <div class="item flex flex-col items-center cursor-pointer hover:text-blue-600">
                <div class="logo  p-2 rounded-lg">
